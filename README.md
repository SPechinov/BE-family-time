...
- логин с access и refresh токенами в `httpOnly` cookie;
...
- use cases: [src/useCases/auth/index.ts](/Users/sergei/Documents/my-projects/BE-family-time/src/useCases/auth/index.ts)
- HTTP controller: [src/api/rest/routes/auth/controller.ts](/Users/sergei/Documents/my-projects/BE-family-time/src/api/rest/routes/auth/controller.ts)

Особенности:

- OTP в dev-режиме возвращается в заголовке `x-dev-otp-code`.
- При логине access и refresh токены выставляются в cookie.
...
- `GET /api/me`: [src/useCases/me/getMe.ts](/Users/sergei/Documents/my-projects/BE-family-time/src/useCases/me/getMe.ts)
- `PATCH /api/me`: [src/useCases/me/patchMeProfile.ts](/Users/sergei/Documents/my-projects/BE-family-time/src/useCases/me/patchMeProfile.ts)
...
- generator: [src/services/tokensSessionsGenerator/tokensSessionsGenerator.ts](/Users/sergei/Documents/my-projects/BE-family-time/src/services/tokensSessionsGenerator/tokensSessionsGenerator.ts)
- payload verifier: [src/services/tokensSessionsPayloadVerifier/tokensSessionsPayloadVerifier.ts](/Users/sergei/Documents/my-projects/BE-family-time/src/services/tokensSessionsPayloadVerifier/tokensSessionsPayloadVerifier.ts)
...
- access и refresh токены читаются из cookie;
- access token blacklist хранится в Redis (TTL);
- refresh sessions хранятся в Redis.

Следствие:

- blacklist access token переживает рестарт процесса;
