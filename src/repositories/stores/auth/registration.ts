...
export class AuthRegistrationStore implements IAuthRegistrationStore {
  readonly #redis: RedisClient;
  readonly #keyPrefix = 'auth';
  ...
  deleteRegistrationCode(props: { userContactsPlain: UserContactsPlainEntity }) {
